...
**Vision Produit :** FrigoFute V2 est la première plateforme mobile française convergente combinant anti-gaspillage alimentaire, nutrition personnalisée, planning repas intelligent et comparateur prix multi-enseignes. L'application transforme le frigo domestique en hub intelligent pour alimentation saine, économique et durable.

**Différenciateur Unique :** Convergence 4-en-1 inédite sur le marché français (vs apps spécialisées isolées). Concurrent le plus proche offre maximum 2 dimensions. FrigoFute livre triple impact mesurable : **santé + économie + écologie**.

**Utilisateurs Cibles :** 4 segments prioritaires identifiés par research marché :
- **Familles organisées** (40% TAM) - Réduction charge mentale, nutrition enfants, économies courses
- **Sportifs optimisateurs** (25% TAM) - Meal prep intelligent, macros précises, performance nutritionnelle
- **Seniors éco-responsables** (20% TAM) - Zéro gaspillage, budget maîtrisé, valeurs alignées
- **Étudiants budget serré** (15% TAM) - Autonomie culinaire, économies massives, simplicité

**Modèle Freemium :** 6 modules gratuits (anti-gaspi basique : inventaire, scan, alertes, recettes, dashboard, profil) + 8 modules premium à 4.99€/mois (nutrition avancée, planning IA, coach IA, comparateur prix, gamification, export/partage).

**Valeur Démontrée (User Testing) :**
- 5-8 kg gaspillage évités/mois par utilisateur
- 50-80€ économisés/mois via comparateur prix
- 2-3h temps gagnées/semaine (planning auto + liste courses)
- ROI premium : 4.99€ investis → 50-80€ économies = **10-16x retour**

**Technologie :** Application mobile native iOS/Android (Flutter 3.32), architecture offline-first, dual-engine OCR (Google Vision + ML Kit), IA générative (Gemini), Firebase backend.

**Objectifs Année 1 :** 150,000 utilisateurs gratuits, 5,000 utilisateurs premium, 90K€ revenus, Top 3 Food Tech France téléchargements catégorie Alimentation.

**Timeline :** 22-24 semaines développement (3 tiers MVP progressifs + 4 phases post-MVP), lancement production semaine 24.

---

## Success Criteria

Les success criteria ci-dessous définissent les objectifs mesurables pour validation du product-market fit à chaque étape de déploiement.
...
La stratégie de livraison progressive ci-dessous permet de valider le product-market fit à chaque étape tout en construisant une base technique solide.

### MVP - Minimum Viable Product

Le MVP FrigoFute V2 est structuré en **3 tiers progressifs**, chacun apportant une couche de valeur incrémentale.
...
Les 4 parcours ci-dessous illustrent comment FrigoFute délivre la valeur triple impact pour chaque segment utilisateur prioritaire.
...
Le contexte food tech français impose des contraintes réglementaires spécifiques pour protéger les consommateurs et garantir la conformité légale.
...
Les parcours utilisateurs ci-dessus révèlent 85 capacités produit organisées en 14 domaines de fonctionnalités.
...
Les exigences non-fonctionnelles ci-dessous définissent les standards de qualité mesurables pour chaque dimension critique du produit.
